...
export const getIntentions = async (req: Request, res: Response, next: NextFunction) => {
...
// @access  Private
export const getIntention = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
// @access  Private
export const updateIntention = async (req: Request, res: Response, next: NextFunction) => {
    await check("title")
      .optional()
      .isString()
      .notEmpty()
...
// @access  Private
export const deleteIntention = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const idValidation = mongoose.Types.ObjectId.isValid(req.params.id);
    if (!idValidation) {
        return res.status(400)
